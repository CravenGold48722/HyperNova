  ...
  if (nav) {
    ...
    const html = `
      <div id="icon-container">
        <a class="icon" href="/./"><img alt="nav" id="HNImg" src="${LogoUrl}"/></a>
      </div>
      <div class="f-nav-right">
        ...
        <a class="navbar-link" href="/./c"><i class="fa-solid fa-gear navbar-icon settings-icon"></i><an>&#83;&#101;&#116;</an><an>&#116;&#105;&#110;&#103;&#115;</an></a>
      </div>`;
    nav.innerHTML = html;
  }
